$(function () {
    ...
    //将class为product-warp下面的a标签绑定点击事件
    $('.product-wrap')
        .on(
            'click',
            'a',
            function (e) {
                ...
                if (target.hasClass('edit')) {
                    //如果有class edit 则点击就进入编辑界面，并带有productId参数
                    window.location.href = '/o2o/shopadmin/productoperation?productId='
                        + e.currentTarget.dataset.id
                } else if (target.hasClass('status')) {
                    //如果有class status 则点击就调用后台功能，并带有productId参数
